...
public class BusinessEntity {
    ...
    private BeneficialOwner beneficialOwners;
    /**
     * officeBearers
     */
    @JsonProperty("office_bearers")
    private List<OfficeBearer> officeBearers;
    /**
     * annualSalesVolumeRange
     */
    @JsonProperty("annual_sales_volume_range")
    private AnnualSalesVolumeRange annualSalesVolumeRange;
    /**
     * averageMonthlyVolumeRange
     */
    @JsonProperty("average_monthly_volume_range")
    private AverageMonthlyVolumeRange averageMonthlyVolumeRange;
    /**
     * purposeCode
     */
