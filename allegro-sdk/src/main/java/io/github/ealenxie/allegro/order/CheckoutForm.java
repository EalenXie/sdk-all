...
public class CheckoutForm {
     ...
     */
    @JsonProperty("buyer")
    private CheckoutFormBuyer buyer;
    /**
     * 支付信息
     */
    ...
    private CheckoutFormInvoice invoice;
    /**
     * 行信息
     */
    @JsonProperty("lineItems")
    private List<CheckoutFormLineItem> lineItems;
    /**
     * 附加费用
     */
    @JsonProperty("surcharges")
    private List<CheckoutFormSurcharge> surcharges;
    /**
     * 折扣
     */
