...
public class AllegroOrdersClient extends AllegroClient {
    ...
    public OrderEvent events(String accessToken, OrderEventQueryParams queryParams) {
        return get("/order/events", accessToken, queryParams, OrderEvent.class);
    }
    ...
    public EventStats eventStats(String accessToken) {
        return get("/order/event-stats", accessToken, null, EventStats.class);
    }
    ...
    public CheckoutForms userOrders(String accessToken, OrdersQueryParams queryParams) {
        return get("/order/checkout-forms", accessToken, queryParams, CheckoutForms.class);
    }
    ...
    public CheckoutForm ordersDetails(String accessToken, String orderId) {
        return get(String.format("/order/checkout-forms/%s", orderId), accessToken, null, CheckoutForm.class);
    }
    ...
    public OrderCarriers orderCarriers(String accessToken) {
        return get("/order/carriers", accessToken, null, OrderCarriers.class);
    }
    ...
    public Shipment getShipment(String accessToken, String orderId) {
        return get(String.format("/order/checkout-forms/%s/shipments", orderId), accessToken, null, Shipment.class);
    }
    ...
    public Shipment shipments(String accessToken, String orderId, ShipmentPayload payload) {
        return post(String.format("/order/checkout-forms/%s/shipments", orderId), accessToken, payload, Shipment.class);
    }
    ...
    public void fulfillment(String accessToken, String orderId, FulfillmentPayload payload) {
        exchange(String.format("/order/checkout-forms/%s/fulfillment", orderId), HttpMethod.PUT, accessToken, null, payload, Object.class);
    }
    ...
    public InvoicesResponse invoices(String accessToken, String orderId) {
        return get(String.format("/order/checkout-forms/%s/invoices", orderId), accessToken, null, InvoicesResponse.class);
    }
    ...
    public IdPayload newInvoice(String accessToken, String orderId, InvoicesPayload payload) {
        return post(String.format("/order/checkout-forms/%s/invoices", orderId), accessToken, payload, IdPayload.class);
    }
    ...
    public void uploadInvoiceFile(String accessToken, String orderId, String invoiceId, byte[] file) {
        exchange(String.format("/order/checkout-forms/%s/invoices/%s/file", orderId, invoiceId), HttpMethod.PUT, accessToken, null, file, Object.class);
    }
    ...
    public CarriersPointsResponse carriersPoints(String accessToken) {
        return get("/order/carriers/ALLEGRO/points", accessToken, null, CarriersPointsResponse.class);
    }
    ...
    public CarriersTrackingResponse carriersTracking(String accessToken, String carrierId, List<String> waybill) {
        return get(String.format("/order/carriers/%s/tracking", carrierId), accessToken, new CarriersTrackingQueryParams(waybill), CarriersTrackingResponse.class);
    }
    ...
    public PaymentOperationsResponse paymentOperations(String accessToken, PaymentsQueryParams queryParams) {
        return get("/payments/payment-operations", accessToken, queryParams, PaymentOperationsResponse.class);
    }
    ...
    public InitiateRefundResponse initiateRefund(String accessToken, InitiateRefundPayload payload) {
        return post("/payments/refunds", accessToken, payload, InitiateRefundResponse.class);
    }
    ...
    public RefundedPaymentsResponse getRefundedPayments(String accessToken, RefundedPaymentsQueryParams queryParams) {
        return get("/payments/refunds", accessToken, queryParams, RefundedPaymentsResponse.class);
    }
    ...
    public DisputesResponse disputes(String accessToken, DisputesQueryParams queryParams) {
        return get("/sale/disputes", accessToken, queryParams, DisputesResponse.class);
    }
    ...
    public Dispute dispute(String accessToken, String disputeId) {
        return get(String.format("/sale/disputes/%s", disputeId), accessToken, null, Dispute.class);
    }
    ...
    public Message getDisputeMessages(String accessToken, String disputeId, PageQueryParams queryParams) {
        return get(String.format("/sale/disputes/%s/messages", disputeId), accessToken, queryParams, Message.class);
    }
    ...
    public Message addMessageToDispute(String accessToken, String disputeId, AddMessageToDisputePayload payload) {
        return post(String.format("/sale/disputes/%s/messages", disputeId), accessToken, payload, Message.class);
    }
    ...
    public void uploadDisputeAttachment(String accessToken, String attachmentId, byte[] file) {
        exchange(buildUri(getUploadHost(), String.format("/sale/dispute-attachments/%s", attachmentId), null), HttpMethod.PUT, new HttpEntity<>(file, getBearerHeaders(accessToken)), Object.class);
    }
    ...
    public byte[] getAttachment(String accessToken, String attachmentId) {
        return get(String.format("/sale/dispute-attachments/%s", attachmentId), accessToken, null, byte[].class);
    }
    ...
    public DeliveryServicesResponse getAvailableDeliveryServices(String accessToken) {
        return get("/parcel-management/delivery-services", accessToken, null, DeliveryServicesResponse.class);
    }
    ...
    public IdInputPayload<ParcelPayload> createNewParcel(String accessToken, String commandId, ParcelPayload payload) {
        return exchange(String.format("/parcel-management/parcel-create-commands/%s", commandId), HttpMethod.PUT, accessToken, null, payload, new ParameterizedTypeReference<IdInputPayload<ParcelPayload>>() {
        });
    }
    ...
    public ParcelCreationStatusResponse getParcelCreationStatus(String accessToken, String commandId) {
        return get(String.format("/parcel-management/parcel-create-commands/%s", commandId), accessToken, null, ParcelCreationStatusResponse.class);
    }
    ...
    public ParcelDetailsResponse getParcelDetails(String accessToken, String parcelId) {
        return get(String.format("/parcel-management/parcels/%s", parcelId), accessToken, null, ParcelDetailsResponse.class);
    }
    ...
    public ProposalsResponse getParcelsPickupDateProposals(String accessToken, ProposalsQueryParams queryParams) {
        return get("/parcel-management/parcels/pickup-date-proposals", accessToken, queryParams, ProposalsResponse.class);
    }
    ...
    public IdInputPayload<ParcelPickupPayload> requestParcelPickup(String accessToken, String commandId, ParcelPickupPayload payload) {
        return exchange(String.format("/parcel-management/parcel-pickup-request-commands/%s", commandId), HttpMethod.PUT, accessToken, null, payload, new ParameterizedTypeReference<IdInputPayload<ParcelPickupPayload>>() {
        });
    }
    ...
    public ParcelPickupStatusResponse getParcelPickupStatus(String accessToken, String commandId) {
        return get(String.format("/parcel-management/parcel-pickup-request-commands/%s", commandId), accessToken, null, ParcelPickupStatusResponse.class);
    }
    ...
    public byte[] getParcelLabel(String accessToken, ParcelLabelQueryParams queryParams) {
        return get("/parcel-management/parcels/label", accessToken, queryParams, byte[].class);
    }
    ...
    public byte[] getParcelsProtocol(String accessToken, String parcelId) {
        return get(String.format("/parcel-management/parcels/protocol/%s", parcelId), accessToken, null, byte[].class);
    }
    ...
    public IdInputPayload<ParcelIdPayload> cancelParcel(String accessToken, String parcelId, String commandId) {
        return exchange(String.format("/parcel-management/parcel-cancel-commands/%s", commandId), HttpMethod.PUT, accessToken, null, new ParcelIdPayload(parcelId), new ParameterizedTypeReference<IdInputPayload<ParcelIdPayload>>() {
        });
    }
    ...
    public IdInputPayload<ParcelIdPayload> getParcelCancellationStatus(String accessToken, String commandId) {
        return get(String.format("/parcel-management/parcel-cancel-commands/%s", commandId), accessToken, null, new ParameterizedTypeReference<IdInputPayload<ParcelIdPayload>>() {
        });
    }
    ...
    public CustomerResponse getCustomerReturns(String accessToken, CustomerQueryParams queryParams) {
        return get("/order/customer-returns", accessToken, queryParams, CustomerResponse.class);
    }
    ...
    public CustomerReturns getCustomerReturnById(String accessToken, String customerReturnId) {
        return get(String.format("/order/customer-returns/%s", customerReturnId), accessToken, null, CustomerReturns.class);
    }
    ...
    public CustomerReturns rejectCustomerReturnRefund(String accessToken, String customerReturnId, Rejection payload) {
        return post(String.format("/order/customer-returns/%s/rejection", customerReturnId), accessToken, payload, CustomerReturns.class);
    }
    ...
    public RefundPayload getRefundApplication(String accessToken, String claimId) {
        return get(String.format("/order/refund-claims/%s", claimId), accessToken, null, RefundPayload.class);
    }
    ...
    public void cancelRefundApplication(String accessToken, String claimId) {
        exchange(String.format("/order/refund-claims/%s", claimId), HttpMethod.DELETE, accessToken, null, null, Object.class);
    }
    ...
    public RefundResponse getRefundApplications(String accessToken, RefundQueryParams queryParams) {
        return get("/order/refund-claims", accessToken, queryParams, RefundResponse.class);
    }
    ...
    public IdPayload createRefundApplication(String accessToken, CreateRefundPayload payload) {
        return post("/order/refund-claims", accessToken, payload, IdPayload.class);
    }
    ...
    public BlackPayload addBlack(String accessToken, BlackPayload payload) {
        return post("/sale/blacklisted-users", accessToken, payload, BlackPayload.class);
    }
    ...
    public void removeBlack(String accessToken, String excludedUserId) {
        exchange(String.format("/sale/blacklisted-users/%s", excludedUserId), HttpMethod.DELETE, accessToken, null, null, Object.class);
    }
}
