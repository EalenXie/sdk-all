package io.github.ealenxie.alyunwms.deser;
...
import io.github.ealenxie.alyunwms.vo.asn.Items;
 ...
 **/
public class AlYunResponseDeserializer extends JsonDeserializer<Object> implements ContextualDeserializer {

    private JavaType javaType;

    public AlYunResponseDeserializer() {
    }

    public AlYunResponseDeserializer(JavaType type) {
        this.javaType = type;
    }

    /**
     * 处理大方广调用失败 {@link Items} data 返回值为[]和{}的问题
     *
     * @author lanzhi
    ...
    public JsonDeserializer<?> createContextual(DeserializationContext context, BeanProperty property) {
        ...
        return new AlYunResponseDeserializer(type);
    }
}
