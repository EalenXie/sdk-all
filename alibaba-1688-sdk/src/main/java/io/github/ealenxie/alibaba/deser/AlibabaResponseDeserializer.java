package io.github.ealenxie.alibaba.deser;
...
import io.github.ealenxie.alibaba.vo.GuaranteesTerm;

import java.io.IOException;
import java.util.Collections;

/**
 * 处理1688泛型返回时，jackson 反序列化失败问题
 *
 * @author lanzhi
 * Created on 2023/1/31 9:31
 **/
public class AlibabaResponseDeserializer extends JsonDeserializer<Object> implements ContextualDeserializer {

    private JavaType javaType;

    public AlibabaResponseDeserializer() {
    }

    public AlibabaResponseDeserializer(JavaType type) {
        this.javaType = type;
    }

    /**
     * 处理1688调用失败 {@link GuaranteesTerm} data 返回值为[]和{}的问题
     *
     * @author lanzhi
    ...
    public JsonDeserializer<?> createContextual(DeserializationContext context, BeanProperty property) {
        ...
        return new AlibabaResponseDeserializer(type);
    }
}
