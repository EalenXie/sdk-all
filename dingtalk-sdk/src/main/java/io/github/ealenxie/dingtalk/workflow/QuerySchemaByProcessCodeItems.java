...
/**
 * @author lanzhi
 * Created on 2023/5/4 11:20
 **/
@Getter
@Setter
public class QuerySchemaByProcessCodeItems {
    /**
     * 子控件列表
     */
    private List<QuerySchemaByProcessCodeChildren> children;
    /**
     * 控件类型，取值：
     * TextField：单行输入框
     * TextareaField：多行输入框
     ...
     * 控件属性
     */
    private QuerySchemaByProcessCodeItemsProps props;
}
